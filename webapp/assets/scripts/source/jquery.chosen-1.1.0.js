...
(function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (this.include_option_in_results(option)) {
          ...
          if (!(option.group && !this.group_search)) {
            ...
            option.search_match = this.search_string_match(option.search_text + " " + option.hint, regex);
            if (option.search_match && !option.group) {
              results += 1;
            }
            if (option.search_match) {
              if (searchText.length && option.search_text.indexOf(searchText) > -1) {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li><i class="glyphicon glyphicon-triangle-bottom"></i></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div>');
      } else {
        this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><i class="glyphicon glyphicon-triangle-bottom"></i></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" /><i class="glyphicon glyphicon-search"></i></div><ul class="chosen-results"></ul></div>');
      }
