  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
        ...
        this.container.html('<a class="chosen-single chosen-default" tabindex="-1"><span>' + this.default_text + '</span><div><i class="glyphicon glyphicon-triangle-bottom"></i></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" /><i class="glyphicon glyphicon-search"></i></div><ul class="chosen-results"></ul></div>');
      }
