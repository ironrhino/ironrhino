...
sed -i '99i CATALINA_OPTS="-server -Xms128m -Xmx1024m -Xmn512m -Xss256k -XX:MetaspaceSize=96M -XX:MaxMetaspaceSize=256m -XX:+UseG1GC -XX:MaxGCPauseMillis=200 -XX:ParallelGCThreads=10 -XX:ConcGCThreads=2 -XX:InitiatingHeapOccupancyPercent=70 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=../logs/dumps -Djava.awt.headless=true -Djava.security.egd=file:/dev/urandom -Djava.net.preferIPv4Stack=true"' tomcat/bin/catalina.sh
