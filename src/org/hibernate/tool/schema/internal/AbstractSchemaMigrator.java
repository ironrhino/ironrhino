...
public abstract class AbstractSchemaMigrator implements SchemaMigrator {
	...
	private void performMigration(
		...
		//TODO start hack by zym
		boolean foreignKeyToIndex = !"false".equals(System.getProperty("hibernate.foreign_key_to_index"));
		if(foreignKeyToIndex) {
			for( Namespace namespace : database.getNamespaces() ) {
				for( Table table : namespace.getTables() ) {
					Map<ForeignKeyKey, ForeignKey> foreignKeys = ReflectionUtils.getFieldValue(table, "foreignKeys");
					Map<String, Index> indexes = ReflectionUtils.getFieldValue(table, "indexes");
