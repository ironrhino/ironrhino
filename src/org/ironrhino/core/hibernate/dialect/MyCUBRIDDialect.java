...
public class MyCUBRIDDialect extends CUBRIDDialect {

	public MyCUBRIDDialect() {
		super();
	...
	protected void registerKeywords() {
		String[] keywords = { "ABSOLUTE", "ACTION", "ADD", "ADD_MONTHS", "AFTER", "ALIAS", "ALL", "ALLOCATE", "ALTER",
				"AND", "ANY", "ARE", "AS", "ASC", "ASSERTION", "ASYNC", "AT", "ATTACH", "ATTRIBUTE", "AVG", "BEFORE",
				"BEGIN", "BETWEEN", "BIGINT", "BIT", "BIT_LENGTH", "BLOB", "BOOLEAN", "BOTH", "BREADTH", "BY", "CALL",
				"CASCADE", "CASCADED", "CASE", "CAST", "CATALOG", "CHANGE", "CHAR", "CHECK", "CLASS", "CLASSES", "CLOB",
				"CLOSE", "CLUSTER", "COALESCE", "COLLATE", "COLLATION", "COLUMN", "COMMIT", "COMPLETION", "CONNECT",
				"CONNECT_BY_ISCYCLE", "CONNECT_BY_ISLEAF", "CONNECT_BY_ROOT", "CONNECTION", "CONSTRAINT", "CONSTRAINTS",
				"CONTINUE", "CONVERT", "CORRESPONDING", "COUNT", "CREATE", "CROSS", "CURRENT", "CURRENT_DATE",
				"CURRENT_TIME", "CURRENT_TIMESTAMP", "CURRENT_DATETIME", "CURRENT_USER", "CURSOR", "CYCLE", "DATA",
				"DATA_TYPE___", "DATABASE", "DATE", "DAY", "DAY_HOUR", "DAY_MILLISECOND", "DAY_MINUTE", "DAY_SECOND",
				"DEALLOCATE", "DEC", "DECIMAL", "DECLARE", "DEFAULT", "DEFERRABLE", "DEFERRED", "DELETE", "DEPTH",
				"DESC", "DESCRIBE", "DESCRIPTOR", "DIAGNOSTICS", "DICTIONARY", "DIFFERENCE", "DISCONNECT", "DISTINCT",
				"DISTINCTROW", "DIV", "DO", "DOMAIN", "DOUBLE", "DROP", "DUPLICATE", "EACH", "ELSE", "ELSEIF", "END",
				"EQUALS", "ESCAPE", "EVALUATE", "EXCEPT", "EXCEPTION", "EXCLUDE", "EXEC", "EXECUTE", "EXISTS",
				"EXTERNAL", "EXTRACT", "FALSE", "FETCH", "FILE", "FIRST", "FLOAT", "FOR", "FOREIGN", "FOUND", "FROM",
				"FULL", "FUNCTION", "GENERAL", "GET", "GLOBAL", "GO", "GOTO", "GRANT", "GROUP", "HAVING", "HOUR",
				"HOUR_MINUTE", "HOUR_MILLISECOND", "HOUR_SECOND", "IDENTITY", "IF", "IGNORE", "IMMEDIATE", "IN",
				"INDEX", "INDICATOR", "INHERIT", "INITIALLY", "INNER", "INOUT", "INPUT", "INSERT", "INT", "INTEGER",
				"INTERSECT", "INTERSECTION", "INTERVAL", "INTO", "IS", "ISOLATION", "JOIN", "KEY", "LANGUAGE", "LAST",
				"LDB", "LEADING", "LEAVE", "LEFT", "LESS", "LEVEL", "LIKE", "LIMIT", "LIST", "LOCAL",
				"LOCAL_TRANSACTION_ID", "LOCALTIME", "LOCALTIMESTAMP", "LOOP", "LOWER", "MATCH", "MAX", "METHOD", "MIN",
				"MINUTE", "MINUTE_MILLISECOND", "MINUTE_SECOND", "MOD", "MODIFY", "MODULE", "MONETARY", "MONTH",
				"MULTISET", "MULTISET_OF", "NA", "NAMES", "NATIONAL", "NATURAL", "NCHAR", "NEXT", "NO", "NONE", "NOT",
				"NULL", "NULLIF", "NUMERIC", "OBJECT", "OCTET_LENGTH", "OF", "OFF", "OID", "ON", "ONLY", "OPEN",
				"OPERATION", "OPERATORS", "OPTIMIZATION", "OPTION", "OR", "ORDER", "OTHERS", "OUT", "OUTER", "OUTPUT",
				"OVERLAPS", "PARAMETERS", "PARTIAL", "PENDANT", "POSITION", "PRECISION", "PREORDER", "PREPARE",
				"PRESERVE", "PRIMARY", "PRIOR", "PRIVATE", "PRIVILEGES", "PROXY", "PROCEDURE", "PROTECTED", "QUERY",
				"READ", "RECURSIVE", "REF", "REFERENCES", "REFERENCING", "REGISTER", "RENAME", "REPLACE", "RESIGNAL",
				"RESTRICT", "RETURN", "RETURNS", "REVOKE", "RIGHT", "ROLE", "ROLLBACK", "ROLLUP", "ROUTINE", "ROW",
				"ROWNUM", "ROWS", "SAVEPOINT", "SCHEMA", "SCOPE___", "SCROLL", "SEARCH", "SECOND", "SECOND_MILLISECOND",
				"MILLISECOND", "SECTION", "SELECT", "SENSITIVE", "SEQUENCE", "SEQUENCE_OF", "SERIALIZABLE", "SESSION",
				"SESSION_USER", "SET", "SETEQ", "SETNEQ", "SET_OF", "SHARED", "SHORT", "SIBLINGS", "SIGNAL", "SIMILAR",
				"STATISTICS", "STRING", "STRUCTURE", "SUBCLASS", "SUBSET", "SUBSETEQ", "SUBSTRING", "SUM", "SUPERCLASS",
				"SUPERSET", "SUPERSETEQ", "SYS_CONNECT_BY_PATH", "SYSTEM_USER", "SYS_DATE", "SYS_TIME", "SYS_DATETIME",
				"SYS_TIMESTAMP", "SYSDATE", "SYSTIME", "SYSDATETIME", "SYSTIMESTAMP", "SYS_USER", "TABLE", "TEMPORARY",
				"TEST", "THEN", "THERE", "TIME", "TIMESTAMP", "DATETIME", "TIMEZONE_HOUR", "TIMEZONE_MINUTE", "TO",
				"TRAILING", "TRANSACTION", "TRANSLATE", "TRANSLATION", "TRIGGER", "TRIM", "TRUNCATE", "TRUE", "TYPE",
				"UNDER", "UNION", "UNIQUE", "UNKNOWN", "UPDATE", "UPPER", "USAGE", "USE", "USER", "USING", "UTIME",
				"VALUE", "VALUES", "VARCHAR", "VARIABLE", "VARYING", "VCLASS", "VIEW", "VIRTUAL", "VISIBLE", "WAIT",
				"WHEN", "WHENEVER", "WHERE", "WHILE", "WITH", "WITHOUT", "WORK", "WRITE", "XOR", "YEAR", "YEAR_MONTH",
				"ZONE" };
