	...
	MYSQL {
		...
		protected String getRecommendedJdbcUrlQueryString() {
			return "createDatabaseIfNotExist=true&serverTimezone=" + TimeZone.getDefault().getID()
					+ "&autoReconnectForPools=true&useUnicode=true&useCursorFetch=true&cachePrepStmts=true&tinyInt1isBit=false&socketTimeout=60000&sslMode=DISABLED&allowPublicKeyRetrieval=true&nullCatalogMeansCurrent=true";
		}
