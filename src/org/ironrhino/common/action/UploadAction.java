...
@AutoConfig(fileupload = "image/*,video/*,text/*,application/javascript,application/x-shockwave-flash,application/pdf,application/msword,application/vnd.ms-excel,application/vnd.ms-powerpoint,application/wps-*,application/vnd.openxmlformats-*,application/font-*,application/octet-stream,application/zip,application/x-rar-compressed")
