...
public class FreemarkerManager {
	...
	protected SimpleHash buildScopesHashModel(ServletContext servletContext, HttpServletRequest request, HttpServletResponse response, ObjectWrapper wrapper, ValueStack stack) {
    ...
    public SimpleHash buildTemplateModel(ValueStack stack, Object action, ServletContext servletContext, HttpServletRequest request, HttpServletResponse response, ObjectWrapper wrapper) {
    	SimpleHash model = buildScopesHashModel(servletContext, request, response, wrapper, stack);
    ...
    protected void populateContext(SimpleHash model, ValueStack stack, Object action, HttpServletRequest request, HttpServletResponse response) {
