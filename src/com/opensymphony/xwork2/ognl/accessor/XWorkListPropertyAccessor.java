        ...
        if (name instanceof Number
            ...
            if (listSize <= index) {
                ...
                if (index > autoGrowCollectionLimit) {
                    throw new OgnlException("Error auto growing collection size to " + index + " which limited to " + autoGrowCollectionLimit);
                }
    ...
    public void setProperty(Map context, Object target, Object name, Object value)
        ...
        if (target instanceof List && name instanceof Number) {
            ...
            if(count > autoGrowCollectionLimit)
            	throw new OgnlException("Error auto growing collection size to " + count + " which limited to " + autoGrowCollectionLimit);
            if (count >= listSize) {
