...
<#macro captcha theme="">
<#if captchaRequired!>
	<@s.textfield label="%{getText('captcha')}" name="captcha" class="required captcha" style="width:60px;" dynamicAttributes={'data-captcha':'${base}/captcha.jpg?token=${session.id}'}/>
</#if>
</#macro>
