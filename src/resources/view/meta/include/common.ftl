...
<#macro captcha theme="">
<#if captchaRequired!>
	<@s.textfield label="%{getText('captcha')}" name="captcha" cssClass="required captcha" cssStyle="width:60px;" dynamicAttributes={'data-captcha':'${base}/captcha.jpg?token=${session.id}'}/>
</#if>
</#macro>
