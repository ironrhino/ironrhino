...
<#else>
<li><a href="${resultPage.renderUrl(1)}" title="${getText('firstpage')}" rel="first"<@dynAttrs value=dynamicAttributes/>>&lt;&lt;</a></li>
<li><a href="${resultPage.renderUrl(resultPage.previousPage)}" title="${getText('previouspage')}" rel="prev"<@dynAttrs value=dynamicAttributes/>>&lt;</a></li>
</#if>
...
<#else>
<li><a href="${resultPage.renderUrl(resultPage.nextPage)}" title="${getText('nextpage')}" rel="next"<@dynAttrs value=dynamicAttributes/>>&gt;</a></li>
<li><a href="${resultPage.renderUrl(resultPage.totalPage)}" title="${getText('lastpage')}" rel="last"<@dynAttrs value=dynamicAttributes/>>&gt;&gt;</a></li>
</#if>
</ul>
</div>
</#if>
