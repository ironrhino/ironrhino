...
<#assign columns={"username":{"width":"120px"},"name":{"width":"120px"},"email":{"width":"180px"},"phone":{"width":"120px"},"roles":{"alias":"role","template":r"<#list value as r>${beans['userRoleManager'].displayRole(r)}<#if r?has_next> </#if></#list>"},"enabled":{"width":"80px"}}>
