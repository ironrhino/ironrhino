...
<div id="scheduled">
	...
	<div class="row-fluid">
		...
		<div class="span3"><input type="checkbox" name="${task.name}"<#if !circuitBreaker??> disabled</#if><#if !circuitBreaker?? || !circuitBreaker.isShortCircuit(task.name)> checked="checked"</#if> class="switch"/></div>
