...
<body>
<#assign columns={"path":{"alias":"path","width":"300px","template":"<a href=\"${getUrl(cmsPath)}$"+"{value}\" target=\"_blank\">$"+"{value}</a>"},"title":{},"tags":{"template":r"<#list entity.tags as tag><a href='<@url value='/common/page?keyword=tags:${tag}'/>' class='ajax view'>${tag}</a>&nbsp;&nbsp;</#list>"},"createDate":{"width":"130px"},"modifyDate":{"width":"130px"},"displayOrder":{"width":"60px"}}>
